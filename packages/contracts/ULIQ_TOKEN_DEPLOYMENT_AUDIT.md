...
Mario confirmed Treasury Safe `0x9C96F9AE59e30786fD325EFD969884FC1f751739` as the initial mint recipient on 2026-09-05. This closes the recipient-selection sub-item of D-01. Minting all 1 billion ULIQ there gives its quorum immediate control over all tokens. That does not itself implement the separate buckets and release schedules in [ADR-002](../../docs/plans/active/uliq/ADR_002_TOKEN_ALLOCATION_VESTING.md), as revised by [ADR-009](../../docs/plans/active/uliq/ADR_009_TWO_ROUND_PRESALE_TOKENOMICS.md). The updated [role matrix](./ULIQ_PRESALE_V2_MAINNET_ROLES.md) records this limited confirmation, not approval of the complete downstream allocation architecture.
...
4. Preserve the existing [ADR-001 Mainnet NO-GO](../../docs/plans/active/uliq/ADR_001_LEGAL_PRESALE_MODEL.md) until its responsible owners explicitly close it. This is a repository release gate, not a new legal determination by this review.
