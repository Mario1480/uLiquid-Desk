...
export const uliqPresaleRoundAbi = parseAbi([
  ...
  "function inventorySource() view returns (address)",
  "function state() view returns (uint8)",
  "function saleStart() view returns (uint64)",
  "function saleEnd() view returns (uint64)",
  ...
  "function unsoldReleasedUliqRaw() view returns (uint256)",
  "function unsoldInventoryUliqRaw() view returns (uint256)",
  "function inventoryFunded() view returns (bool)",
  ...
  "function fundInventory()",
  "function markReady()",
  "function releaseUnsold() returns (uint256 amount)",
