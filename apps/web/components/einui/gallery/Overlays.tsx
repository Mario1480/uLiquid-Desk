...
export default function Overlays({name}: {name:string}) {
 ...
 switch(name) {
  case "glass-dialog": return <GlassDialog><GlassDialogTrigger asChild>{button}</GlassDialogTrigger><GlassDialogContent><GlassDialogTitle>Local dialog / Lokaler Dialog</GlassDialogTitle><GlassDialogDescription>Focus, Escape and scroll-lock example.</GlassDialogDescription><label>Sample input<GlassInput nativeLayout className="input"/></label></GlassDialogContent></GlassDialog>;
  ...
  case "glass-popover": return <GlassPopover><GlassPopoverTrigger asChild>{button}</GlassPopoverTrigger><GlassPopoverContent><label>Sample filter<GlassInput nativeLayout className="input"/></label></GlassPopoverContent></GlassPopover>;
