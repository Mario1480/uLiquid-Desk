...
| Prisma engine cache/offline policy | `docs/reference/prisma-engine-cache-and-offline-builds.md` reviewed; cache hit/miss noted |  |  |
...
| Market intelligence providers | `npm -w apps/api run test:market-intelligence`; verify RSS partial failure, official calendar UTC, citations and stale mode |  | `docs/reference/market-intelligence-operations.md` |
...
| Type-safety ratchet | `docs/plans/active/type-safety-strictness-plan.md` reviewed; budget decreases recorded |  |  |
