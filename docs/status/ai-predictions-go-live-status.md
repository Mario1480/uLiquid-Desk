...
Diese Doku haelt den aktuellen Go-live-Status der AI Predictions fest. Sie ergaenzt `docs/reference/prediction-refresh-scheduler.md`, `docs/reference/prediction-evaluator.md` und `docs/quality/ai-evaluation-framework.md`.
