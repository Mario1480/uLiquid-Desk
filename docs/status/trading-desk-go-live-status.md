...
Diese Doku haelt den aktuellen Go-live-Status des manuellen Trading Desks fest. Sie ergaenzt `docs/architecture/manual-trading-desk.md`, `docs/status/gridbot-go-live-status.md` und `docs/status/botvault-go-live-followups.md`.
