...
> Historical tracker note, 2026-09-11: this checklist was not updated as later
> implementation and production releases landed. Use the
> [program README](README.md) and
> [active program closeout register](../../../status/active-program-closeout.md)
> for current status. The unchecked entries below remain the original acceptance
> specification and must not be counted as current implementation gaps.
