...
- [x] Standalone spot enrichment is implemented and API/web-deployed as `9c31dbe6b` in the [closeout slice](../../archive/tasks/2026-09-06-phase2-spot-closeout-slice.md): shared candles/indicators and orderbook, no derivatives, owner-checked Paper resolution, public credentials and cache v5. Running-image public Binance spot smoke passed; authenticated browser and broader provider acceptance remain open.
