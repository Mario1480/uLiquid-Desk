...
- `README.md`
- `docs/reference/exchange-capability-matrix.md`
- `docs/runbooks/paper-trading-smoke-test.md`
- `docs/architecture/ts-python-grid-contract.md`
- `docs/architecture/ts-python-strategy-contract.md`
- `docs/architecture/runner-reconciliation-standards.md`
- `docs/quality/regression-matrix.md`
- `docs/architecture/manual-trading-desk.md`
- `docs/architecture/vault-architecture.md`
